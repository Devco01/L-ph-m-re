...
function buildReglementEmbed(client) {
  const description = [
    ...
    '',
    '🛡️ **Vérification de l’âge & protection des mineurs :**',
    ...
    '',
    '🚨 **Protection des mineurs & comportements inappropriés :**',
    ...
    '',
    '🌸 En rejoignant Chill Zoneˢᶠᵂ | FR, vous acceptez l’intégralité de ce règlement.',
  ].join('\n');

  return new EmbedBuilder()
    .setColor(COLOR_OTHER)
    .setAuthor(getBotAuthor(client))
    .setTitle(`${SAKURA} Bienvenue sur Chill Zoneˢᶠᵂ | FR ${SAKURA}`)
